...
# Загружаем файл
df = pd.read_csv("C:\\Users\\danii\\Desktop\\итмо\\модель\\dataset\\здание\\здание.csv")

# Переименовываем нужные столбцы
df = df.rename(columns={
    "Time": "Date",
    "electricity_demand_values[kw]": "Electricity load (kW)"
})
...
# Сохраняем результат
output_path = os.path.join('output.xlsx')
